...
<head>
  ...
  <title>WorkConnect | Admin DashBoard</title>
...
<%
	...
	<div class="toast-container" style="position: absolute; top: 10px; right: 10px;">
        <div class="toast fade show">
            ...
            <div class="toast-body">
               <h5><b> Logged in successfully! Welcome Admin
            </b></h5>
            </div>
        </div>
        </div>
    ...
    if (hour < 12){
    %>
        	 <h1>Admin DashBoard | Good Morning , Admin</h1>
    	<% 
    	
    }else if(hour>=12 &&hour<17){
    	%>
    	<h1>Admin DashBoard | Good Afternoon , Admin</h1>
    	<%
    }else{
    	%>
    	<h1>Admin DashBoard | Good Evening , Admin</h1>
    	<%
    }
    %>

...
<head>
  ...
  <title>WorkConnect | User Login</title>
...
<%try{
			boolean msg = (boolean) session.getAttribute("resgiter-user-success");
			if (msg==true) {
			%>
        ...
        <div class="toast fade show">
            ...
            <div class="toast-body">
               <h5><b> Registration Successfully ! We Have Sent a Mail To Verify Your Account.Please Verify Before Login, without verification you can't Login.
            </b></h5>
            </div>
        </div>
        </div>
			...
			session.removeAttribute("resgiter-user-success");
			%>
			<%try{
			Boolean msg1 = (Boolean) session.getAttribute("user-login-fail");
			if (msg1==false) {
			%>
				<div class="toast-container" style="position: absolute; top: 10px; right: 10px;">
        ...
        <div class="toast fade show">
            ...
            <div class="toast-body">
               <h5><b>Invalid UserName or Password !!</b></h5>
            </div>
        </div>
    </div>
			<%
...
<%try{
        ...
        <div class="toast fade show">
            ...
            <div class="toast-body">
              <h5><b>Email Not Verified ! Please Verify your email , verification link is already sent to registered email id
            </b></h5>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="../UserLoginController" method="post" class="row g-3 needs-validation" novalidate>
